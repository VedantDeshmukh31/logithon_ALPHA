...
def session_delete_view(request, pk):
    ...
    if session.is_current_session:
        messages.error(request, "You cannot delete current country")
        return redirect("session_list")
    else:
        session.delete()
...
def semester_delete_view(request, pk):
    ...
    if semester.is_current_semester:
        messages.error(request, "You cannot delete current port")
        return redirect("semester_list")
    else:
        semester.delete()
        messages.success(request, "Port successfully deleted")
    return redirect("semester_list")
