...
BUSAN_PORT = "Port of Busan"
ANTWERP_PORT = "Port of Antwerp"
HAMBURG_PORT = "Port of Hamburg"
LOS_ANGELES_PORT = "Port of Los Angeles"
LONG_BEACH_PORT = "Port of Long Beach"
